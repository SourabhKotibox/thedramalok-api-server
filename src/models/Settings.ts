...
const SettingsSchema = new Schema<ISettings>(
  {
    // Business
    platformName: { type: String, default: 'The Drama Lock' },
    contactNo: { type: String, default: '' },
    inquiryEmail: { type: String, default: '' },
    siteDescription: { type: String, default: '' },
    copyrightText: { type: String, default: '© 2026 The Drama Lock. All Rights Reserved.' },
    ...
    splashVideoUrl: { type: String, default: '' },
    // Mail
