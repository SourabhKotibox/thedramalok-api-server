 ...
 *   API_URL=https://thedramalock.app/api
 */

/** Base API URL — strips trailing slash for consistency */
export const API_URL = (process.env.API_URL || 'https://thedramalock.app/api').replace(/\/$/, '');
 ...
 *
 * Example output: https://thedramalock.app/api/share/64abc123...
 */
